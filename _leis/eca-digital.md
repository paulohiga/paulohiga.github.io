...
VII – sistema operacional: *software* de sistema que controla as funções básicas de um *hardware* ou *software* e permite que aplicações de internet, programas de computador, aplicativos ou outros *software*s sejam executados por meio dele;
