...
#
# Convertido do HTML oficial do EUR-Lex; ver `formato: ue` em AGENTS.md. Fora
# do texto ficaram os 180 considerandos e o aparato de notas de rodapé do JO
# (referências de publicação), pelo peso da página. O articulado e os anexos
# estão íntegros.
---
