...
O processo administrativo sancionador é instaurado pela área de fiscalização da Agência — a Coordenação-Geral de Fiscalização, no desenho da Resolução nº 1/2021 — e segue um caminho previsível, com contraditório e ampla defesa em cada etapa:
...
Há ainda uma saída negociada, prevista no [art. 55-J, XVII](#art-55-j-xvii): o agente pode propor **compromisso** — na prática, um termo de ajustamento de conduta — para eliminar irregularidade ou situação contenciosa. A proposta vai ao Conselho Diretor; assinado o termo, o processo fica suspenso e, cumprido integralmente o compromisso, é arquivado.
