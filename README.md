...
| [`docs/notas-navegacao.md`](./docs/notas-navegacao.md) | Backlog de melhorias de `/notas` — navegação, leitura e fluidez entre notas e entre painéis: o que foi medido, o que já foi feito e o que falta |
