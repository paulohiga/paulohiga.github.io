...
seletor de normas grava na URL quando o leitor troca de norma, para a escolha
poder ser compartilhada e sobreviver a um recarregamento — a norma principal é
o padrão e não leva marca. Um link escrito à mão pode usar a mesma forma
quando o destino é a norma inteira, e não um artigo dela. A troca de norma
também guarda, enquanto a aba estiver aberta, onde o leitor parou em cada
norma, e devolve-o ao mesmo ponto quando ele volta.
