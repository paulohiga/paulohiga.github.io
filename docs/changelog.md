...
- A página passou a exibir o total de menções de cada verbete, somando as formas de busca nos comentários e nos textos normativos, e ganhou a ordenação “Mais citados” e o agrupamento por nota, com contagem separada por jurisdição.
